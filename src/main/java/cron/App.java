...
/**
* The Cron program implements an application that
* simply parses a cron input and returns a table with minute, hour, day(month)
* month, day(week) and command.
*
...
public class App {
    ...
    // This funciton takes a field type which can be minute, hour, etc and the actual input field.
    ...
    // Ex 1-5 for minute means 1 2 3 4 5, but 1-60 would throw an exception as 60 is > Minute.max
    public String parseField(Field field, String input) throws InvalidInputException { 
        ...
        //Step values
            ...
            try{
                ...
                System.out.println(minuteOutput.toString());
            } catch(NumberFormatException e) {
                System.out.println(e);
                System.exit(0);
            }
